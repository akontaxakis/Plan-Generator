...
public class Random_advance_physical_experiment {


    public static void main(String[] args) {
        lib utils = new lib();
        double dataset_size = 1.6; // your dataset size here
        ...
        //System.out.println("Budgets -> " + budget);
                ...
                double shared_cost = shared_cummulative_cost / edge_cost_modifier * computation_cost_per_second + dataset_budget_cost;
                //   Budget = [dataset_size / 10, dataset_size, dataset_size * 10, dataset_size * 100,  dataset_size * 1000]


                budget_cost = ((Budget[budget]) * 10 * 0.023) +dataset_budget_cost;
