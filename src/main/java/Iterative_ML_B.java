    ...
    public static void main(String[] args) {
        ...
        for(int budget=0; budget<b;budget++){
            ...
            for (int iteration = 0; iteration < iterations; iteration++) {
                ...
                HyperGraph shared = utils.Artifacts_and_edges_ToHyperGraph(project_path, uid+"_"+budget, iteration, "shared");
            ...
            System.out.println(budget + "," + equivalent_cummulative_cost + "," + limited_cummulative_cost + "," + shared_cummulative_cost);
        }
    }
